...
<div class="magazine-page">
    <div class="container">
        ...
        <div class="tab__wrap magazine-page__wrap">
            <div class="tab-part" >
                <div class="magazine-page__part">
                    <div class="magazine-page__item">
                        ...
                        <div class="magazine__name">Статьи Тюменская компания получила первое разрешение на КРТ земли из
                            федеральной
                            собственности
                        </div>
