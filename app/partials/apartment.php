    ...
    <div class="apartments__text">
        <div class="apartments__header">
            <div class="apartments__left">
                <h4>Двухкомнатная, 48 м²</h4>
                <div class="apartments__desc">Исетский р-н, село Шорохово, ул Калинина, д 16</div>
            </div>
            <div class="apartments__right">
                <h4>1 050 000 ₽</h4>
                <div class="apartments__desc">21 875 ₽/м²</div>
            </div>
        </div>
        <div class="apartments__info">
            <div class="apartments__info-item">
                <span>Площадь</span>
                <div>48 м²</div>
            </div>
            <div class="apartments__info-item">
        ...
        <div class="apartments__longtext check-length" data-max="450">Срочно!!!!!! Продам квартиру. Центр Инфраструктура
            ...
            Срочно!!!!!! Продам квартиру. Центр Инфраструктура развита магазины в шаговой доступности , рейсовые
            автобусы, школа через дорогу от дома , детский сад , спорткомплекс. Магазин строительных материалов
            , продуктовые , магнит ) В Квартире Косметический ремонт Имеется небольшой огород возле дома
            Бесплатное оформление ипотеки по сниженным ставкам от банков-партнеров. Подаем
        </div>
        <div class="apartments__row">
            <a href="tel:73452215142" class="button transparent medium">
